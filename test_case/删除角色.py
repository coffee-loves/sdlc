...
driver.find_element_by_css_selector(".btn.md-raised.cf-btn-default.md-button.ng-scope.md-ink-ripple").click()
driver.find_element_by_css_selector(".btn.md-raised.md-warn.add-task-btn.cf-btn-warn.md-button").click()
